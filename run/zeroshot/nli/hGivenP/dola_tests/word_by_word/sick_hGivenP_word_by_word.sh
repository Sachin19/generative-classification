...
bash run/zeroshot/nli/hGivenP/dola_tests/word_by_word/nli_word_by_word.sh $task $dataset $data_dir $data_files $split $textfield1 $textfield2 $labelfield $label2id $jobid $hypGivenPrem
