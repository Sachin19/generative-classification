...
bash run/zeroshot/nli/hGivenP/dola_tests/jsd_avg/nli_jsd_avg.sh $task $dataset $data_dir $data_files $split $textfield1 $textfield2 $labelfield $label2id $jobid $hypGivenPrem
