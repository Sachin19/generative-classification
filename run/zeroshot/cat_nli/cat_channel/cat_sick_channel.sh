...
bash run/zeroshot/cat_nli/cat_channel/cat_all_channel2.sh $task $dataset $data_dir $data_files $split $textfield1 $textfield2 $labelfield $jobid $label2id $cat_seed
