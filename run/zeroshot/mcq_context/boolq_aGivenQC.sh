...
bash run/zeroshot/mcq_context/mcq_context.sh $task $dataset $data_dir $data_files $split $question $context $labelfield $label2id $jobid $unmasked $possible_labels
