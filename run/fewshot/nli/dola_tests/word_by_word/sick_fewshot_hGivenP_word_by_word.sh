...
bash run/fewshot/nli/dola_tests/word_by_word/nli_fewshot_word_by_word.sh $task $dataset $data_dir $data_files $split $textfield1 $textfield2 $labelfield $label2id $jobid $label_names 1 $model
