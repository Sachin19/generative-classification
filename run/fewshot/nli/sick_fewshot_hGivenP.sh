...
bash run/fewshot/nli/nli_fewshot_hGivenP.sh $task $dataset $data_dir $data_files $split $textfield1 $textfield2 $labelfield $label2id $jobid $label_names 1 $model
