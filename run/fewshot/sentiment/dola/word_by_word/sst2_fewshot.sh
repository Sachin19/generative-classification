...
bash run/fewshot/sentiment/dola/word_by_word/sentiment_fewshot.sh $task $dataset $data_dir $data_files $split $textfield $labelfield $label2id $jobid $label_names 1
