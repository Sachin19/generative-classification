...
def get_evaluation_set(subset, few_shot_k=0, few_shot_seed=0):
    dataset = load_dataset("adv_glue", subset, ignore_verifications=True)#, cache_dir="/projects/tir5/users/sachink/generative-classifiers/2023/datasets/")
...
def map_hf_dataset_to_list(hf_dataset, split_name):
    ...
    for datapoint in hf_dataset[split_name]:
        ...
        lines.append((datapoint["sentence"].strip(), datapoint["label"]))
    return lines