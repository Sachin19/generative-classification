...
TASK2CONTEXT = {
    ...
    "sentiment2-adv": ["Movie review: {text}"],
    "sentiment2-advmix": ["Movie review: {text}"],
...
TASK2INSTRUCT = {
    ...
    "sentiment2-adv": ["Is this movie review negative or positive? {text}"],
    "sentiment2-advmix": ["Is this movie review negative or positive? {text}"],
