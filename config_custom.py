TASK2LABELSTRINGS = {
    "rte_hGivenP": [
        [
            ...
            # Sachins' new: not as good
            # "This Wikipedia excerpt: {text1} entails this: {text2}",
            # "This news excerpt: {text1} implies this: {text2}",
            # "This Wikipedia excerpt: {text1} suggests this: {text2}",
            # "This news excerpt: {text1} argues this: {text2}",
            # "This Wikipedia excerpt: {text1} posits this: {text2}",
            # "This news excerpt: {text1} uncovers this: {text2}",
            # "This Wikipedia excerpt: {text1} pronounces this: {text2}",
            # "This news excerpt: {text1} exposes this: {text2}",
            # "This Wikipedia excerpt: {text1} illustrates this: {text2}",
            # "This news excerpt: {text1} elucidates this: {text2}",
            # "This Wikipedia excerpt: {text1} explicates this: {text2}",

            # og: best so far...
            "Domain: Wikipedia and news. This: {text1} entails this: {text2}",
            "Domain: Wikipedia and news. The premise: {text1} supports the hypothesis: {text2}",
            "Domain: Wikipedia and news. From the premise: {text1} we can derive the hypothesis: {text2}",
            "Domain: Wikipedia and news. The premise: {text1} suggests the following hypothesis: {text2}",
            "Domain: Wikipedia and news. The premise: {text1} can infer the hypothesis: {text2}",
            "Domain: Wikipedia and news. The argument: {text1} does result in the hypothesis: {text2}",
            "Domain: Wikipedia and news. This: {text1} does give rise to: {text2}",
            "Domain: Wikipedia and news. The premise: {text1} warrants the hypothesis: {text2}",
            "Domain: Wikipedia and news. This premise: {text1} agrees with this hypothesis: {text2}",
            "Domain: Wikipedia and news. The premise: {text1} implies the hypothesis: {text2}", 
            "Domain: Wikipedia and news. Given this premise: {text1} the following hypothesis does entail: {text2}",
        ...
        [
            ...
            #sachin new: not as good?
            # "This Wikipedia except: {text1} contradicts this: {text2}",
            # "This news excerpt: {text1} contradicts this: {text2}",
            # "This Wikipedia excerpt: {text1} opposes this: {text2}",
            # "This news excerpt: {text1} refutes this: {text2}",
            # "This Wikipedia excerpt: {text1} challenges this: {text2}",
            # "This news excerpt: {text1} undermines this: {text2}",
            # "This Wikipedia excerpt: {text1} discredits this: {text2}",
            # "This news excerpt: {text1} controverts this: {text2}",
            # "This Wikipedia excerpt: {text1} contradicts this: {text2}",
            # "This news excerpt: {text1} opposes this: {text2}",
            # "This Wikipedia excerpt: {text1} challenges this: {text2}",
            
            #og
            "Domain: Wikipedia and news. This: {text1} contradicts this: {text2}",
            "Domain: Wikipedia and news. The premise: {text1} undermines the hypothesis: {text2}",
            "Domain: Wikipedia and news. From the premise: {text1} we cannot derive the hypothesis: {text2}",
            "Domain: Wikipedia and news. The premise: {text1} does not suggest the following hypothesis: {text2}",
            "Domain: Wikipedia and news. The premise: {text1} cannot infer the hypothesis: {text2}",
            "Domain: Wikipedia and news. The argument: {text1} doesn't result in the hypothesis: {text2}",
            "Domain: Wikipedia and news. The foundation: {text1} doesn't give rise to: {text2}",
            "Domain: Wikipedia and news. The premise: {text1} omits the hypothesis: {text2}",
            "Domain: Wikipedia and news. This premise: {text1} disagrees with this hypothesis: {text2}",
            "Domain: Wikipedia and news. The premise: {text1} opposes the hypothesis: {text2}",
            "Domain: Wikipedia and news. The premise {text1} clashes with the hypothesis {text2}",
    ...
    "rte_pGivenH": [
        [
            ...
            "This premise includes the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "The premise embodies the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "This premise supports the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "The premise contains the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "This premise agrees with the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "The premise integrates the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "This premise carries the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "The premise encapsulates the hypothesis\nhypothesis: {text1}\npremise: {text2}",
        ...
        [
            ...
            "This premise disputes the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "The premise denies the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "This premise opposes the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "The premise challenges the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "This premise negates the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "The premise discredits the hypothesis\nhypothesis: {text1}\npremise: {text2}",
            "This premise rebuts the hypothesis\nhypothesis: {text1}\npremise: {text2}",
    ...
    "mnli_hGivenP": [
        [
            "Domain: spoken and written test. This: {text1}, entails this: {text2}",
            "Domain: spoken and written test. The premise: {text1} supports the hypothesis: {text2}",
            "Domain: spoken and written test. From the premise: {text1} we can derive the hypothesis: {text2}",
            "Domain: spoken and written test. The premise: {text1} suggests the following hypothesis: {text2}",
            "Domain: spoken and written test. The premise: {text1} can infer the hypothesis: {text2}",
            "Domain: spoken and written test. The argument: {text1} does result in the hypothesis: {text2}",
            "Domain: spoken and written test. This: {text1} does give rise to: {text2}",
            "Domain: spoken and written test. The premise: {text1} warrants the hypothesis: {text2}",
            "Domain: spoken and written test. This premise: {text1} agrees with this hypothesis: {text2}",
            "Domain: spoken and written test. The premise: {text1} implies the hypothesis: {text2}", 
            "Domain: spoken and written test. Given this premise: {text1} the following hypothesis does entail: {text2}",
            # "The argument: {text1} as the premise results in the hypothesis: {text2}",
            # "The proposition: {text1} leads naturally to the hypothesis: {text2}",
            # "The foundation {text1} bolsters the theory {text2}",
            # "The basic idea {text1} reinforces the supposition {text2}",
        ...
        [
            "Domain: spoken and written test. The premise: {text1} is neutral to the hypothesis: {text2}",
            "Domain: spoken and written test. This: {text1}  is neutral to this: {text2}",
            "Domain: spoken and written test. This: {text1} holds a neutral position to: {text2}",
            "Domain: spoken and written test. The premise: {text1} is indifferent towards the hypothesis: \", {text2}\"",
            "Domain: spoken and written test. This: {text1} is indifferent towards: {text2}",
            "Domain: spoken and written test. There is a neutral relationship between: {text1} and: {text2}",
            "Domain: spoken and written test. The premise: {text1} is indifferent concerning the hypothesis: {text2}",
            "Domain: spoken and written test. This: {text1} is indifferent concerning: {text2}",
            "Domain: spoken and written test. The premise: {text1} is impartial to the hypothesis: {text2}",
            "Domain: spoken and written test. This: {text1} is impartial to: {text2}",
            "Domain: spoken and written test. The premise: {text1} is impartial regarding the hypothesis: {text2}",
            # "The premise {text1} remains impartial to the hypothesis {text2}",
            # "Premise {text1} is unaligned with hypothesis {text2}",
            # "The basis {text1} is indifferent to the theory {text2}",
            # "{text1} as a premise, is detached from {text2} as a hypothesis.",
        ...
        [
            "Domain: spoken and written test. This: {text1}, contradicts this: {text2}",
            "Domain: spoken and written test. The premise: {text1} undermines the hypothesis: {text2}",
            "Domain: spoken and written test. From the premise: {text1} we cannot derive the hypothesis: {text2}",
            "Domain: spoken and written test. The premise: {text1} does not suggest the following hypothesis: {text2}",
            "Domain: spoken and written test. The premise: {text1} cannot infer the hypothesis: {text2}",
            "Domain: spoken and written test. The argument: {text1} doesn't result in the hypothesis: {text2}",
            "Domain: spoken and written test. The foundation: {text1} doesn't give rise to: {text2}",
            "Domain: spoken and written test. The premise: {text1} omits the hypothesis: {text2}",
            "Domain: spoken and written test. This premise: {text1} disagrees with this hypothesis: {text2}",
            "Domain: spoken and written test. The premise: {text1} opposes the hypothesis: {text2}",
            "Domain: spoken and written test. The premise {text1} clashes with the hypothesis {text2}",
            # "Premise {text1} is in conflict with hypothesis {text2}",
            # "The basis {text1} opposes the theory {text2}",
            # "The premise {text1}, disputes the hypothesis {text2}",
            # "The starting point {text1} negates the idea {text2}",
